...
class join_final extends StatefulWidget {
  final String id,team;
  final int type;
  join_final({this.id,this.team,this.type});

  @override
  _join_finalState createState() => _join_finalState();
}

class _join_finalState extends State<join_final> {

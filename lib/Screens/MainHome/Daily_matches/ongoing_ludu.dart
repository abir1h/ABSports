...
class ongoing_ludu extends StatefulWidget {
  final String type,image;
  ongoing_ludu({this.type,this.image});
  @override
  _ongoing_luduState createState() => _ongoing_luduState();
}

class _ongoing_luduState extends State<ongoing_ludu> {
  Future slide;
  Future<List<dynamic>> emergency() async {
    ...
    var response = await http.get(
        Uri.parse(AppUrl.ongoin + widget.type.toString()),

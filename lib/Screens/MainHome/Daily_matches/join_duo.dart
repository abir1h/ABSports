...
import 'package:sports_club/Screens/MainHome/Daily_matches/join_duo_final.dart';
import 'package:sports_club/Screens/MainHome/Daily_matches/join_final.dart';

class join_duo extends StatefulWidget {
  @required
  final String id;
  @required
  final int type;
  join_duo({this.id, this.type});
  @override
  _join_duoState createState() => _join_duoState();
}

class _join_duoState extends State<join_duo> {
  var teama = 4;
  var fake_id;
                                                              ...
                                                              onChanged: (v) {
                                                                ...
                                                                setState(() {
                                                                  ...
                                                                  print(selected.toString());
                                                                    ...
                                                                    msg: "Can't Select More than two slot",
                                                                    toastLength: Toast.LENGTH_LONG,
                                                                    gravity: ToastGravity.BOTTOM,
                                                                    timeInSecForIosWeb: 1,

...
class solo_join_final extends StatefulWidget {
  final String id,team,fakeid;
  final int type;
  solo_join_final({this.id,this.team,this.type,this.fakeid});

  @override
  _solo_join_finalState createState() => _solo_join_finalState();
}

class _solo_join_finalState extends State<solo_join_final> {
  ...
  bool add=false;
  bool joined = false;
  Joinmatch(String player, match_id, int entry,String type) async {
    ...
    request.fields.addAll({'player': player, 'amount': entry.toString(),
      'fake_id':widget.fakeid.toString(),
      'team_type':widget.team,

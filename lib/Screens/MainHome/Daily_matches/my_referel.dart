...
class _my_referState extends State<my_refer> {
  ...
  Future<List<refferel_>> fetchMEdicine() async {
    ...
    var response =
        await http.get(Uri.parse(AppUrl.my_referral), headers: requestHeaders);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.push(
                context, MaterialPageRoute(builder: (_) => refere()));
          },
        ),
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Center(
                  child: Text("My Referral Summary",
                      style: GoogleFonts.lato(
                          color: Colors.black,

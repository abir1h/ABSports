...
import 'package:sports_club/Screens/MainHome/Daily_matches/roompop_ludo.dart';
                                                                ...
                                                                Column(
                                                                  children: [
                                                                    ...
                                                                    Row(
                                                                      ...
                                                                      children: [
                                                                        Image.asset('Images/t.png',height: 25,width: 25,),
                                                                        Text('  ' + snapshot.data[index]['entry_fee'], style: GoogleFonts.lato(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 16)),
                                                                      ],
                                                                    ),
                                                                  ],
                                                                ),
                                                          ...
                                                          children: [
                                                              ...
                                                              Container(
                                                                ...
                                                                Column(
                                                                  children: [
                                                                    ...
                                                                    Text(snapshot.data[index]['type']=='Solo'?"Single".toUpperCase():snapshot.data[index]['type'].toUpperCase(), style: GoogleFonts.lato(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 14)),
                                                                  ],
                                                                ),
                                                              ),
                                                            ),
                                                            Expanded(
                                                              ...
                                                              Container(
                                                                ...
                                                                Column(
                                                                  children: [
                                                                    Text('Board Type', style: GoogleFonts.lato(color: Colors.black, fontWeight: FontWeight.w600, fontSize: 14)),
                                                                    Text(snapshot.data[index]['version'].toUpperCase(), style: GoogleFonts.lato(color: Colors.white, fontWeight: FontWeight.w600, fontSize: 14)),
                                                                  ],
                                                                ),
                                                              ),
                                                            ),

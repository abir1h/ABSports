...
class _statisticsState extends State<statistics> {
  ...
  Future<List<dynamic>> emergency() async {
    ...
    var response =
        await http.get(Uri.parse(AppUrl.statistics), headers: requestHeaders);
  ...
  void initState() {
    ...
    slide = emergency();
    notification_timer =
        Timer.periodic(Duration(seconds: 10), (_) => slide = emergency());
  }
                                                              ...
                                                              Container(
                                                                ...
                                                                child: Row(
                                                                  children: [
                                                                    Flexible(
                                                                      child: Text(
                                                                          snapshot.data[index]['games'][0]['title'] +
                                                                              " | " +
                                                                              snapshot.data[index]['games'][0][
                                                                                  'type'] +
                                                                              " | " +
                                                                              snapshot.data[index]['games'][0][
                                                                                  'game_id'],
